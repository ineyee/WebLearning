<template>
  <div class="tab-bar">
    ...
    -->
    <van-tabbar v-model="selectedIndex" v-show="curShowRoute.meta.showTabBar" active-color="#FF9854FF"
      inactive-color="#999999FF" :safe-area-inset-bottom="true">
...
<script setup>
import { ref } from "vue";
// 注意这里是useRoute不是useRouter，useRoute hook函数用来获取当前正显示在屏幕上的路由界面
