...
const router = createRouter({
  ...
  */
  ...
  routes: [
    ...
    { path: "/home", component: () => import("../home/page/home-page.vue") },
    { path: "/favor", component: () => import("../favor/page/favor-page.vue") },
    { path: "/order", component: () => import("../order/page/order-page.vue") },
    { path: "/message", component: () => import("../message/page/message-page.vue") },
  ],
});
