...
// -------------实际开发中，修改入口文件和出口目录、文件一般都是通过修改打包配置文件来实现-------------
...
// webpack就会帮我们打包项目了，而且webpack打包时就是找我们自定义的入口文件“main.js”了，并且打包成功后，webpack会在项目的根目录下默认创建一个名为“build”的文件夹和一个名为“your_project_1.0.0_release.js”的文件