...
__DEFINE__(1737978460971, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1737978460972,"./event-store":1737978460973}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1737978460972, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1737978460973, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1737978460972,"./utils":1737978460974}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1737978460974, function(require, module, exports) {
...
return __REQUIRE__(1737978460971);
})()
